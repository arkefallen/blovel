        ...
        <div class="py-3">
            ...
            <div class="row g-5">
                    <div class="col-md-5 col-lg-4 order-md-last">
                        ...
                        <form action="{{ route('gallery.update', $gallery->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="col-md-7 col-lg-8">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="gallery_name" placeholder="contoh : Kondisi Terkini" required="true" value="{{ $gallery->gallery_name }}">
                        </div>

                        <div class="col-12">
                            <label for="status" class="form-label">Artikel</label>
                            <select name="article_id" class="form-control" required="true">
                                <option> - Pilih Artikel - </option>
                                @foreach ($articles as $article)
                                    <option 
                                    @if ($gallery->article_id == $article->id)
                                        selected
                                    @endif
